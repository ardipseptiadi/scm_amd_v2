...
$hasil = mysql_query("SELECT id_supplier,nama_supplier, alamat_supplier, kontak, email, status FROM t_supplier") or die (mysql_error());
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <div style="text-align: right;">
		<a type="button" href="form/form_tambah_supplier.php" class="btn btn-warning">Tambah Data Supplier </a>  
	</div> <br>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href="<?php echo "form/form_ubah_status_supplier.php?&nama_supplier=".$row['nama_supplier']."&status=".$row['status']; ?>"><?php echo $row['status']; ?></a></td>
			
				<td><a href="<?php echo "form/form_ubah_supplier.php?&nama_supplier=".$row['nama_supplier']."&alamat_supplier=".$row['alamat_supplier']."&kontak=".$row['kontak']."&email=".$row['email']; ?>">UBAH</a> </td>
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
