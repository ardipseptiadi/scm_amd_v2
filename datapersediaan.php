...
$hasil = mysql_query("SELECT nama_material, sisa, safety_stock, status FROM t_material") or die (mysql_error());
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <a type="button" href="form/form_tambah_persediaan.php" class="btn btn-warning">Tambah Persediaan </a>
    <a type="button" href="form/form_Kurang_persediaan.php" class="btn btn-warning">Kurang Persediaan </a>
  </div> <br>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href="<?php echo "form/form_ubah_status_persediaan.php?&nama_material=".$row['nama_material']."&status=".$row['status']; ?>"><?php echo $row['status'];?></a></td>
