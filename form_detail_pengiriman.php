...
$hasil2 = mysql_query("SELECT no_polisi, tgl_kirim, status FROM t_pengiriman where id_detail_pemesanan IN(SELECT id_detail_pemesanan FROM t_detail_pemesanan WHERE kode_pesan='$id')");
...
<div class="container-fluid text-center">
  <div class="row content">
	...
	<a type="button" href="datapengiriman.php" class="btn btn-default">Kembali </a>
   </div>
    <div class="col-sm-1 sidenav">
