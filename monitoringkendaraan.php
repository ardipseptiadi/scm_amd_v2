...
$hasil = mysql_query("SELECT no_polisi, jenis_kendaraan,kendaraan, kapasitas, status FROM t_kendaraan") or die (mysql_error());
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <table class="table table-bordered table-striped">
        ...
        <td><?php echo $row['kendaraan']; ?></td>
				...
				<td><a href="<?php echo "form/form_ubah_status_kendaraan.php?&nopolisi=".$row['no_polisi']."&status=".$row['status']; ?>"><?php echo $row['status']; ?></a></td>
			
				<td><a href="<?php echo "form/form_ubah_kendaraan.php?&nopolisi=".$row['no_polisi']."&jeniskendaraan=".$row['jenis_kendaraan']."&kapasitas=".$row['kapasitas']; ?>">UBAH</a> </td>
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
