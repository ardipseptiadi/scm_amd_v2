...
$hasil = mysql_query("select t_pengiriman.tgl_kirim, t_pemesanan.kode_pesan, t_kendaraan.no_polisi, t_agen.nama_agen, t_pengiriman.status,t_karyawan.nama_karyawan
from t_pengiriman join t_detail_pemesanan on t_pengiriman.id_detail_pemesanan = t_detail_pemesanan.id_detail_pemesanan
join t_pemesanan on t_detail_pemesanan.kode_pesan = t_pemesanan.`kode_pesan`
join t_kendaraan on t_pengiriman.no_polisi = t_kendaraan.no_polisi
JOIN t_agen ON t_pemesanan.id_agen = t_agen.`id_agen`
join t_karyawan on t_pengiriman.id_karyawan=t_karyawan.id_karyawan") or die (mysql_error());
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <div style="text-align: right;">
		<a type="button" href="form/form_tambah_pengiriman.php" class="btn btn-warning">Tambah Data Pengiriman </a>  
	</div> <br>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href="<?php echo "form/form_ubah_status_pengiriman.php?&kode_pesan=".$row['kode_pesan']."&status=".$row['status']; ?>"><?php echo $row['status']; ?></a></td>
			  <td><?php echo $row['nama_karyawan']; ?></td>
				<td><a href=" <?php echo "form_detail_pengiriman.php?&id=".$row['kode_pesan']; ?> ">Detail</a></td> 
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
