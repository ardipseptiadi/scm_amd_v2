...
$id= $_GET['no_polisi'];
$hasil = mysql_query("SELECT t_pemesanan.kode_pesan,t_pemesanan.tgl_pesan, t_produk.jenis, t_produk.harga, t_detail_pemesanan.jumlah, t_detail_pemesanan.sub_total
...
$hasil2 = mysql_query("SELECT no_polisi, tgl_kirim, t_karyawan.`nama_karyawan` FROM t_pengiriman 
JOIN t_karyawan ON t_pengiriman.`id_karyawan`= t_karyawan.`id_karyawan`
WHERE no_polisi='$id'");
...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<a type="button" href="monitoringpengiriman.php" class="btn btn-default">Kembali </a>  
   </div>
    <div class="col-sm-1 sidenav">
