...
$hasil = mysql_query("select t_pengiriman.tgl_kirim, t_pemesanan.kode_pesan, t_kendaraan.no_polisi, t_agen.nama_agen, t_pengiriman.status
...
JOIN t_agen ON t_pemesanan.id_agen = t_agen.`id_agen`") or die (mysql_error());
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="verifikasi/verifikasipemesanan.php">Data Pemesanan</a></li>
      <li role="separator" class="divider"></li>
      <li><a href="verifikasi/verifikasipengadaan">Data Pengadaan</a></li>
          </ul>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href=" <?php echo "monitoring_detail_pengiriman.php?&id=".$row['kode_pesan']; ?> ">Detail</a></td> 
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
