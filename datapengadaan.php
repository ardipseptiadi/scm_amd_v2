...
<div class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <a href="indexpurchasing.php"><img src="logo.png" class="img-responsive" alt="Responsive image" ></a>    </div>
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <div style="text-align: right;">
		<a type="button" href="form/form_tambah_pengadaan.php" class="btn btn-warning">Tambah Data Pengadaan </a></div> <br>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href=" <?php echo "form_detail_pengadaan.php?&id=".$row['id_pengadaan']; ?> ">Detail</a></td>
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
