...
<body>
<?php
$namaagen=$_GET['nama_agen'];
$alamatagen=$_GET['alamat_agen'];
$kontak=$_GET['kontak'];
$email=$_GET['email'];
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
      ...
      <hr>
	  <center><h3> Form Ubah Data Agen</h3></center><br />
	  <form class="form-horizontal" name="ubahagen" method="post" action="../proses/proses_ubah_agen.php">
  <div class="form-group">
    <label for="input_namaagen" class="col-sm-2 control-label">Nama Agen</label>
    <div class="col-sm-4">
      <input type="text" name="namaagen" class="form-control" id="input_namaagen" placeholder="Masukan Nama" required value="<?php echo $namaagen  ?>">
	  <input type="hidden" name="idnamaagen" class="form-control" id="input_namaagen" placeholder="Masukan Nama" value="<?php echo $namaagen  ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="input_alamatagen" class="col-sm-2 control-label">Alamat Agen</label>
    <div class="col-sm-4">
      <input type="text" name="alamat_agen" class="form-control" id="input_alamatagen" placeholder="Masukan Alamat" required value="<?php echo $alamatagen  ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="input_kontak" class="col-sm-2 control-label" required>Kontak</label>
    <div class="col-sm-4">
