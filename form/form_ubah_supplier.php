...
$alamatsupplier=$_GET['alamat_supplier'];
$kontak=$_GET['kontak'];
$email=$_GET['email'];
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
      ...
      <hr>
	  <center><h3> Form Ubah Data Supplier</h3></center><br />
	  <form class="form-horizontal" name="ubahsupplier" method="post" action="../proses/proses_ubah_supplier.php">
  <div class="form-group">
    <label for="input_namasupplier" class="col-sm-2 control-label">Nama Supplier</label>
    <div class="col-sm-4">
      <input type="text" name="namasupplier" class="form-control" id="input_namasupplier" placeholder="Masukan Nama" required value="<?php echo $namasupplier  ?>"disable="disable">
	  <input type="hidden" name="idnamasupplier" class="form-control" id="input_namasupplier" placeholder="Masukan Nama" value="<?php echo $namasupplier  ?>"disable="disable">
    </div>
  </div>
  <div class="form-group">
    <label for="input_alamatsupplier" class="col-sm-2 control-label">Alamat Supplier</label>
    <div class="col-sm-4">
      <input type="text" name="alamat_supplier" class="form-control" id="input_alamatsupplier" placeholder="Masukan Alamat" required value="<?php echo $alamatsupplier  ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="input_kontak" class="col-sm-2 control-label">Kontak</label>
    <div class="col-sm-4">
      <input type="text" name="kontak" class="form-control" id="input_kontak" placeholder="Masukan Nomor" required value="<?php echo $kontak  ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="input_email" class="col-sm-2 control-label">Email</label>
    <div class="col-sm-4">
      <input type="text" name="email" class="form-control" id="input_email" placeholder="Masukan Email" required value="<?php echo $email  ?>">
    </div>
  </div>
  <div class="form-group">
