...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <form class="form-horizontal" name="tambahsupplier" method="post" action="../proses/proses_tambah_supplier.php">
  <div class="form-group">
    <label for="input_namasupplier" class="col-sm-2 control-label">Nama Supplier</label>
    <div class="col-sm-4">
      <input type="text" name="namasupplier" class="form-control" id="input_namasupplier" placeholder="Masukan Nama" required>
    </div>
  </div>
  <div class="form-group">
    <label for="input_alamatsupplier" class="col-sm-2 control-label">Alamat Supplier</label>
    <div class="col-sm-4">
      <input type="text" name="alamat_supplier" class="form-control" id="input_alamatsupplier" placeholder="Masukan Alamat" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <select class="form-control" name="statussupplier" required>
	  	<option>Pilih</option>
  		<option>Aktif</option>
