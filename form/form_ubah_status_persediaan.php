...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
      <h1>Pengolahan Data Peersediaan</h1>
      <hr>
	  <center><h3> Form Ubah Status Data Persediiaan</h3></center><br />
	  <form class="form-horizontal" name="ubahstatuspersediaan" method="post" action="../proses/proses_ubah_status_persediaan.php">
	  <div class="form-group">
    <label for="input_nama_material" class="col-sm-2 control-label">Nama Material</label>
    <div class="col-sm-4">
      <input type="text" name="nama_material" class="form-control" id="input_nama_material" required value="<?php echo $nama_material  ?>">
	  
    </div>
	</div>
  <div class="form-group">
    <label for="input_status" class="col-sm-2 control-label">Status Persediaan</label>
   	<div class="col-sm-4">
      <select class="form-control" name="status" required>
	  	<option> Pilih</option>
  		<option>Persediaan aman</option>
  		<option>Persediaan tidak aman</option>
	</select>
    </div>
  </div>
  <div class="form-group">
