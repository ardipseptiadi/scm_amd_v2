...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
      ...
      <hr>
	  <center><h3> Form Ubah Status Data Agen</h3></center><br />
	  <form class="form-horizontal" name="ubahstatusagen" method="post" action="../proses/proses_ubah_status_agen.php">
	  <div class="form-group">
    <label for="input_namaagen" class="col-sm-2 control-label">Nama Agen</label>
    <div class="col-sm-4">
      <input type="text" name="namaagen" class="form-control" id="input_namaagen" placeholder="Masukan Nama" value="<?php echo $namaagen  ?>">
