...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <form class="form-horizontal" name="tambahproduk" method="post" action="../proses/proses_tambah_produk.php">
  <div class="form-group">
    <label for="input_produk" class="col-sm-2 control-label">Kode Produk</label>
    <div class="col-sm-4">
      <input type="text" name="produk" class="form-control" id="input_produk" placeholder="Masukan kode produk" required>
    </div>
  </div>
  <div class="form-group">
    <label for="input_jenis" class="col-sm-2 control-label">Jenis Produk</label>
    <div class="col-sm-4">
      <input type="text" name="nama_jenis" class="form-control" id="input_jenis" placeholder="Masukan jenis Produk" required>
    </div>
  </div>
  <div class="form-group">
    <label for="input_harga" class="col-sm-2 control-label">Harga</label>
    <div class="col-sm-4">
      <input type="text" name="harga" class="form-control" id="input_harga" placeholder="Masukan Harga" required>
    </div>
  </div>
  <div class="form-group">
    <label for="input_jumlah" class="col-sm-2 control-label">Jumlah Stok</label>
    <div class="col-sm-4">
      <input type="text" name="jumlah" class="form-control" id="input_jumlah" placeholder="Masukan stok awal " required>
    </div>
  </div>
  <div class="form-group">
