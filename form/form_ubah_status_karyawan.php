...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
      ...
      <hr>
	  <center><h3> Form Ubah Status Data Karyawan</h3></center><br />
	  <form class="form-horizontal" name="ubahstatuskaryawan" method="post" action="../proses/proses_ubah_status_karyawan.php">
	  <div class="form-group">
    <label for="input_nip" class="col-sm-2 control-label">Nip</label>
    <div class="col-sm-4">
      <input type="text" name="nip" class="form-control" id="input_nip" placeholder="Masukan Nip" required  value="<?php echo $nip  ?>"disable="disable">
	  <input type="hidden" name="idnip" class="form-control" id="input_nip" placeholder="Masukan Nip" required value="<?php echo $nip  ?>"disable="disable">
    </div>
  </div>
  <div class="form-group">
    <label for="input_nama" class="col-sm-2 control-label">Nama</label>
    <div class="col-sm-4">
      <input type="text" name="nama_karyawan" class="form-control" id="input_namakaryawan" placeholder="Masukan Nama" required value="<?php echo $namakaryawan  ?>"disable="disable">
    </div>
  </div>
  <div class="form-group">
    <label for="input_statuskaryawan" class="col-sm-2 control-label" required>Status Karyawan</label>
    <div class="col-sm-4">
