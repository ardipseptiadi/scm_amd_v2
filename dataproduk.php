...
$hasil = mysql_query("SELECT kode_produk, jenis, harga, jumlah FROM t_produk") or die (mysql_error());
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <div style="text-align: right;">
		<a type="button" href="form/form_tambah_produk.php" class="btn btn-warning">Tambah Data Produk </a>  
	</div> <br>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href="<?php echo "form/form_ubah_produk.php?&kode_produk=".$row['kode_produk']."&jenis=".$row['jenis']."&harga=".$row['harga']; ?>">UBAH</a> </td>
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
