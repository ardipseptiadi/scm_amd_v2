...
$hasil = mysql_query("SELECT id_karyawan, nip, nama_karyawan, kontak, jabatan, email, status, password FROM t_karyawan") or die (mysql_error());
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left"> 
	  ...
	  <div style="text-align: right;">
		<a type="button" href="form/form_tambah_karyawan.php" class="btn btn-warning">Tambah Data Karyawan </a>  
	</div> <br>
		...
		<tbody>
		 ...
		 $i=1;
			...
			<tr> 			
				...
				<td><a href="<?php echo "form/form_ubah_status_karyawan.php?&nip=".$row['nip']."&nama_karyawan=".$row['nama_karyawan']."&status=".$row['status']; ?>"><?php echo $row['status']; ?></a></td>
			
				<td><a href="<?php echo "form/form_ubah_karyawan.php?&nip=".$row['nip']."&nama_karyawan=".$row['nama_karyawan']."&kontak=".$row['kontak']."&jabatan=".$row['jabatan']."&email=".$row['email']; ?>">UBAH</a> </td>
			</tr>
		<?php $i++;}  ?>
		</tbody>
	</table>
