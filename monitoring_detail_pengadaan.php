...
$hasil2 = mysql_query(" SELECT id_pengadaan, tgl_pengadaan, verifikasi FROM t_pengadaan where id_pengadaan='$id'");
...
<div class="container-fluid text-center">    
  ...
  <a type="button" href="monitoringpengadaan.php" class="btn btn-default">Kembali </a>  
   </div>
    <div class="col-sm-1 sidenav">
